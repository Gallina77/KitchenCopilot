...
with engine.begin() as conn:
    ...
    '(date DATE, description TEXT, is_bankHoliday BOOLEAN, ' \
    'is_semesterBreak BOOLEAN, is_bridgeDay BOOLEAN);'))
    ...
    'weather_temp FLOAT, weather_condition TEXT, is_bank_holiday BOOLEAN, is_bridge_day BOOLEAN, is_semester_break BOOLEAN, ' \
    'holiday_description TEXT, predicted_meals INTEGER, prediction_timestamp DATETIME);'))

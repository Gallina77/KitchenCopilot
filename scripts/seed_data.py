...
holidays_df['is_bank_holiday'] = holidays_df['is_bank_holiday'].str.strip().eq('TRUE').astype(bool)
holidays_df['is_semester_break'] = holidays_df['is_semester_break'].str.strip().eq('TRUE').astype(bool)
holidays_df['is_bridge_day'] = holidays_df['is_bridge_day'].str.strip().eq('TRUE').astype(bool)

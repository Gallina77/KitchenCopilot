    ...
    if not df.empty:
        ...
        st.dataframe(
            ...
            column_config={
                ...
                "predicted_meals_salad": st.column_config.NumberColumn(label=daily_comparison_columns["predicted_meals_salad"], width="small",format="%.2f",),
                "actual_meals_salad": st.column_config.NumberColumn(label=daily_comparison_columns["actual_meals_salad"], width="small", format="%.2f",),
